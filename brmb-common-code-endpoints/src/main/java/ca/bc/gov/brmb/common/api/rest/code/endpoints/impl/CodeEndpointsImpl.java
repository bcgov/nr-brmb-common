...
public class CodeEndpointsImpl extends BaseEndpointsImpl implements CodeEndpoints {
    ...
    @Override
    public Response deleteCode(String codeTableName, String codeName, String userEmail) {
        ...
        try {
            ...
            service.deleteCode(codeTableName, optimisticLock, codeName, userEmail, getFactoryContext());
